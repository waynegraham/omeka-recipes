  ...
  namespace :omeka do
    ...
    namespace :maintenance do
      ...
      task :start, :roles => :web, :except => { :no_release => true } do
        require 'erb'
        on_rollback { run "rm -f #{shared_path}/system/#{maintenace_basename}.html" }
        ...
        put result, "#{shared_path}/system/#{maintenace_basename}.html", :mode => 0644
      end
    end

    desc <<-DESC
      Enables the application web-accessible again. Removes the \n
      "#{maintenace_basename}.html" page generated by deploy:maitenance:start,
